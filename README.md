      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=60&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/astropy-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314t" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add astropy astropy-base
# for installing globally
pixi global install astropy astropy-base
```
...
It is possible to list all of the versions of `astropy` available on your platform:
...
```
pixi search astropy --channel conda-forge
```
